...
@click.option('--target-table', default='yellow_taxi_data', help='Target table name in the database')
def run(year, month, pg_user, pg_password, pg_host, pg_port, pg_db, chunksize, target_table):
    ...
    for df_chunk in tqdm(df_iter):
        if first:
            ...
            print("Inserted first chunk. Rows:", len(df_chunk))
            first = False
